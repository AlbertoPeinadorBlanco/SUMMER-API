...
async function insertDemoBanners() {
    try {
        ...
        const query = `
            ...
            ('Upgrade to Premium', 'https://images.unsplash.com/photo-1502680390469-be75c86b636f?w=1200&q=80', 'https://example.com', 'marketplace_sidebar', 1),
            ...
            ('Instructor Bottom Ad', 'https://images.unsplash.com/photo-1502680390469-be75c86b636f?w=1200&q=80', 'https://example.com', 'instructors_bottom', 1),
            ('Gear Guide Ad', 'https://images.unsplash.com/photo-1502680390469-be75c86b636f?w=1200&q=80', 'https://example.com', 'gear_guide_bottom', 1),
            ('Welcome Ad', 'https://images.unsplash.com/photo-1502680390469-be75c86b636f?w=1200&q=80', 'https://example.com', 'home_top', 1),
            ('Bottom Footer Ad', 'https://images.unsplash.com/photo-1502680390469-be75c86b636f?w=1200&q=80', 'https://example.com', 'home_bottom', 1)
        `;
